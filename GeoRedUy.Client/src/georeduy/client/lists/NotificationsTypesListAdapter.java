// NotificationsTypesListAdapter

// adaptador para lista de tipos de notificaciones.
// lo usa la actividad ConfigureNotificationTypesActivity.
...
public class NotificationsTypesListAdapter extends BaseAdapter {
    ...
    public NotificationsTypesListAdapter (Activity activity,
    ...
    public View getView (int position, View convertView, ViewGroup parent) {
        ...
        View vi = convertView;
        if (convertView == null) {
            vi = _inflater.inflate (R.layout.notitypes_list_item, null);
        }
 
        // initialize views
        TextView viewNotitypeId = (TextView) vi.findViewById (R.id.notitype_id);
